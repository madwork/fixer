...
Populate the newly-created table by running either of the folloing rake tasks:
...
As should be apparent, the first parameter is the base currency and second is the quoted currency.
